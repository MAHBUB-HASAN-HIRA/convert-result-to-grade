const confirm_btn = document.getElementById('confirm_btn');
    ...
    confirm_btn.addEventListener('click', (e) => {
        ...
        convert_to_grade('get_phy_acco_log_input', 'get_phy_acco_log_grade', 'get_phy_acco_log_gpa');
        convert_to_grade('get_che_bus_geo_input', 'get_che_bus_geo_grade','get_che_bus_geo_gpa');
        convert_to_grade('get_math_fin_civic_input', 'get_math_fin_civic_grade', 'get_math_fin_civic_gpa');
        convert_to_grade('get_bio_pro_soc_input', 'get_bio_pro_soc_grade', 'get_bio_pro_soc_gpa');
